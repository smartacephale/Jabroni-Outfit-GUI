...
<template>
  <div class=":uno: text-lg flex items-center justify-between p-2 border-b-2 select-none 
    ...
    <div class=":uno: flex items-center gap-2">
      ...
      <span class=":uno: font-medium font-mono! tracking-widest text-base">{{ title }}</span>
    </div>
    <div class=":uno: flex gap-2">
      <Sun class=":uno: text-lg hover:text-gray-500 cursor-pointer transition-colors"
        @click="props.state.darkmode = !props.state.darkmode" />
      <Minus class=":uno: text-lg hover:text-gray-500 cursor-pointer transition-colors"
